...
namespace BoatGraphics
{
	...
	public class Boat : IDrawObject, IEquatable<Boat>
	{
		...
		//конструктор со строкой, для создания объекта из файла
		...
		{
			return (this.BodyColor == other.BodyColor) && (this.Weight == other.Weight) && (this.Speed == other.Speed);
		}
